...
export default function AvatarUploadCrop(props: Record<string, unknown>) {
  return (<>
{/* TODO: {{- /* we do not need to set for/id here, global aria init code will add them automatically * / -}} */}
...
{/* TODO: {{- /* the cropper-panel must be next sibling of the input "avatar" * / -}} */}
