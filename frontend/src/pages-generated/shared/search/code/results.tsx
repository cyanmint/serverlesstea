...
<div className="flex-text-block tw-flex-wrap">
	...
	<a className={`ui ${(props.language === "$term.Language") ? `primary` : ""} basic label tw-m-0`}
		href={`?q=${String(props.keyword ?? "")}${(props.language !== "$term.Language") ? `&l=` : ""}&search_mode=${String(props.selectedSearchMode ?? "")}`}>
