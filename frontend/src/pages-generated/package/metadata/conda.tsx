...
{(props.packageDescriptor?.package?.type === "conda") ? (<>
	{(props.packageDescriptor?.metadata?.license) ? (<><div className="item"><span className="svg-icon" aria-label="octicon-law"></span> {props.packageDescriptor?.metadata?.license as any}</div></>) : null}
