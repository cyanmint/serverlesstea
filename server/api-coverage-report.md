...
**Total endpoints:** 51 | **Correct:** 51 | **Stub:** 0 | **Malfunction:** 0 | **Missing:** 0

| Endpoint | Method | Path | Status | Note |
|----------|--------|------|--------|------|
| login (get current user) | `GET` | `/api/v1/user` | **correct** | DB-backed implementation |
| createToken (login) | `POST` | `/api/v1/users/{username}/tokens` | **correct** | DB-backed implementation |
...
| getMyOrgs | `GET` | `/api/v1/user/orgs` | **correct** | DB-backed implementation |
| getMyRepos | `GET` | `/api/v1/user/repos` | **correct** | DB-backed implementation |
...
| getUserIssues (search) | `GET` | `/api/v1/repos/issues/search` | **correct** | DB-backed implementation |
...
| getRepoActivities | `GET` | `/api/v1/repos/{owner}/{repo}/activities/feeds` | **correct** | DB-backed implementation |
| listAdminUsers | `GET` | `/api/v1/admin/users` | **correct** | DB-backed implementation |
| listAdminOrgs | `GET` | `/api/v1/admin/orgs` | **correct** | DB-backed implementation |